...
class CrossPointWebServer {
 ...
 private:
  ...
  void handleGetLibraryBooks() const;
  void handleGetLibraryShelves() const;
  void handlePostLibraryShelfCreate();
  void handlePostLibraryShelfRename();
  void handlePostLibraryShelfDelete();
  void handlePostLibraryAssign();
  ...
  // Obsidian clipping-sync handlers
