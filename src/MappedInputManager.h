...
class MappedInputManager {
 public:
  ...
  // Only a still-held button can deliver a later release from the same press.
  // Suppressing after a release would discard the user's next real tap.
  void suppressNextBackRelease() { suppressBackRelease = isPressed(Button::Back); }
  void suppressNextConfirmRelease() { suppressConfirmRelease = isPressed(Button::Confirm); }
  void suppressNextPowerRelease() { suppressPowerRelease = isPressed(Button::Power); }
  void suppressNextPowerConfirmRelease() { suppressPowerConfirmRelease = isPressed(Button::Power); }
