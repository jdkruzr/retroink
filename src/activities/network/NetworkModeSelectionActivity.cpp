...
constexpr int NEARBY_SECTION_INDEX = 4;
...
constexpr StrId menuDescs[MENU_ITEM_COUNT] = {StrId::STR_JOIN_DESC,
                                              StrId::STR_CALIBRE_DESC,
                                              StrId::STR_HOTSPOT_DESC,
                                              StrId::STR_SYNC_OBSIDIAN_DESC,
...
void NetworkModeSelectionActivity::selectCurrent() {
  ...
  if (selectedIndex == 1) {
    ...
    mode = NetworkMode::SYNC_OBSIDIAN;
