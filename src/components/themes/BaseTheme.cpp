...
void BaseTheme::fillProgressIndicator(const GfxRenderer& renderer, const Rect rect,
                                      const bool foregroundBlack) const {
  renderer.fillRect(rect.x, rect.y, rect.width, rect.height, foregroundBlack);
}
...
void BaseTheme::drawStatusBar(GfxRenderer& renderer, const float bookProgress, const int currentPage,
  ...
  if (showProgress && statusBar.showsProgressBar()) {
    ...
    fillProgressIndicator(renderer,
                          Rect{orientedMarginLeft, progressBarY, barWidth, statusBar.progressBarHeightPx},
                          foregroundBlack);
  }
